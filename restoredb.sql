...
BEGIN
    ...
    MOVE 'AdventureWorksDW2019_log' TO '/var/opt/mssql/data/AdventureWorksDW2019_log.log',
     NOUNLOAD,  STATS = 5
END
...
BEGIN
    ...
    MOVE 'AdventureWorks2019_log' TO '/var/opt/mssql/data/AdventureWorks2019_log.log',
     NOUNLOAD,  STATS = 5
END